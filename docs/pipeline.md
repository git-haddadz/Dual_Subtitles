...
2. reunir les fragments adjacents attribues au meme locuteur;
3. chercher les pauses acoustiques a l'interieur de chaque tour;
4. couper le tour sur ces pauses;
5. rattacher les fragments trop courts au fragment voisin du meme locuteur;
6. appliquer une limite dure de 12 secondes lorsqu'aucune pause utile
   n'apparait.
